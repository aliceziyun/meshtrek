...
for folder in branch1-yamls branch2-yamls branch4-yamls branch8-yamls; do
# for folder in branch2-yamls; do
    for istio_enabled in false true; do
        ...
        ~/istio-1.26.0/wrk2/wrk -t4 -c16 -R 50 -d 60 -L http://$service0_ip/endpoint1 >> $outfile &
